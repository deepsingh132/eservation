...
import 'package:eservation/auth/auth.service.dart';
import 'package:eservation/auth/signin_enum.dart';
...
class AuthController extends GetxController {
  ...
  handleAuthChanged(isLoggedIn) {
    if (isLoggedIn == false) {
      ...
      Get.offAllNamed("/ReservationList");
    }
  }
  ...
  handleSignOut() async {
    ...
    Get.snackbar("Signed Out", "Loading",
